                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    @foreach($teachers as $teacher)
                        <label class="block cursor-pointer">
                            ...
                            <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 transition hover:border-slate-300 hover:bg-white hover:shadow-sm peer-checked:border-slate-900 peer-checked:bg-slate-900 peer-checked:text-white">
                ...
                @foreach($schedules as $schedule)
                    <article class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <span class="shrink-0 rounded-full px-3 py-1 text-xs font-semibold {{ $schedule->is_active ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-600' }}">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4">
                                        ...
                                        <p class="mt-1 text-slate-500">
                                            {{ $schedule->level ?: 'Sin nivel' }} · {{ $schedule->room ?: 'Sin sala' }}
                                        </p>
                                    </td>
